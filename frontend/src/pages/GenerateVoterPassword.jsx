    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-5 text-white">
          <h2 className="text-2xl font-bold text-center">Generate Voter Password</h2>
          ...
          {voter && otp && (
            <div className="p-5 border border-gray-200 rounded-xl bg-gray-50 space-y-4 animate-fade-in">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-800">Generated Credentials</h3>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="font-semibold text-gray-900 text-lg">{voter.student_id}</p>
                </div>

                <div>
                  <p className="text-sm text-gray-600 font-medium">Generated Password:</p>
                  <div className="flex items-center justify-between mt-1 p-3 bg-white rounded-lg border border-gray-300">
                    <p className="font-mono font-bold text-green-700 text-lg tracking-wide">{otp}</p>
                    <button
                      onClick={handleCopy}
